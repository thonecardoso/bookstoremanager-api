[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=thonecardoso_bookstoremanager-api&metric=alert_status)](https://sonarcloud.io/dashboard?id=thonecardoso_bookstoremanager-api)
